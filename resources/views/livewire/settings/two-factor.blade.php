<section class="w-full">
    ...
    <x-settings.layout
        :heading="__('Autenticación de Dos Factores (2FA)')"
        :subheading="__('Gestiona la configuración de autenticación de dos factores de tu cuenta')"
    >
        <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
            @if ($twoFactorEnabled)
                <div class="space-y-4">
                    ...
                    <flux:text>
                        {{ __('Con la autenticación de dos factores activada, se te solicitará un código PIN seguro y aleatorio durante el inicio de sesión, que puedes obtener de la aplicación compatible con TOTP en tu teléfono.') }}
                    </flux:text>
