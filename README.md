...
- [Theme / Design System (eco dashboard)](#theme--design-system-eco-dashboard)
  - [Paleta de colores](#paleta-de-colores)
  - [Superficies y texto (Dashboard / Landing)](#superficies-y-texto-dashboard--landing)
  - [Tipografía](#tipografía)
  - [Componentes](#componentes)
  - [Dónde se define](#dónde-se-define)
- [Toaster (notificaciones)](#toaster-notificaciones)
  - [Dónde está](#dónde-está)
  - [Uso](#uso)
- [Docker y GCP (Cloud Run)](#docker-y-gcp-cloud-run)
- [Setup inicial (clonar y correr)](#setup-inicial-clonar-y-correr)
  - [Requisitos](#requisitos)
  - [Instalación](#instalación)
  - [PDF de Solicitudes (DomPDF)](#pdf-de-solicitudes-dompdf)
  - [Ejecutar en desarrollo](#ejecutar-en-desarrollo)
  - [Tests](#tests)
- [Credenciales para Login (seed)](#credenciales-para-login-seed)
- [Ciclo de vida de la POC (flujo principal)](#ciclo-de-vida-de-la-poc-flujo-principal)
- [Casos de uso reales (ejemplo Habitissimo)](#casos-de-uso-reales-ejemplo-habitissimo)
- [Esquema de BD (resumen) y relaciones](#esquema-de-bd-resumen-y-relaciones)
- [Dashboard Principal](#dashboard-principal)
  - [Visualización de Datos](#visualización-de-datos)
  - [Tarjetas de Estadísticas](#tarjetas-de-estadísticas)
  - [Cápsulas de Configuración](#cápsulas-de-configuración)
- [Rutas principales](#rutas-principales)
- [Logs y correo (dev)](#logs-y-correo-dev)
- [Datos de Seeders (Chilenos)](#datos-de-seeders-chilenos)
  - [Helper de Datos Chilenos](#helper-de-datos-chilenos)
- [Arquitectura de Permisos](#arquitectura-de-permisos)
  - [Instalación Pendiente](#instalación-pendiente)
  - [Permisos Planificados](#permisos-planificados)
  - [Seeder de Permisos](#seeder-de-permisos)
- [Sistema de Valoraciones](#sistema-de-valoraciones)
  - [Modelo y Relaciones](#modelo-y-relaciones)
  - [Rutas](#rutas)
- [Dashboards Analíticos](#dashboards-analíticos)
  - [Dashboard Cliente](#dashboard-cliente-clientdashboard)
  - [Dashboard Profesional](#dashboard-profesional-providerdashboard)
  - [Configuración de Perfil Profesional](#configuración-de-perfil-profesional-providerprofile-settings)
- [Configuraciones del Sistema](#configuraciones-del-sistema)
  - [Settings Disponibles](#settings-disponibles)
  - [Uso en Código](#uso-en-código)
- [Nuevas Tablas y Campos](#nuevas-tablas-y-campos)
  - [Tablas Nuevas](#tablas-nuevas)
  - [Campos Nuevos](#campos-nuevos)
  - [Estados Nuevos](#estados-nuevos)
- [Comandos Artisan](#comandos-artisan)
  - [Marcar Cotizaciones Vencidas](#marcar-cotizaciones-vencidas)
- [API Endpoints](#api-endpoints)
  - [Búsqueda de Categorías (Select2) — público](#búsqueda-de-categorías-select2--público)
  - [API v1 (Sanctum)](#api-v1-sanctum-solo-planes-pro-y-enterprise)
  - [Documentación OpenAPI (Swagger)](#documentación-openapi-swagger)
- [Sistema de Ofuscación de Datos y Pago Simulado](#sistema-de-ofuscación-de-datos-y-pago-simulado)
  - [Flujo de Visualización de Servicios Publicados](#flujo-de-visualización-de-servicios-publicados)
  - [Modelo de Datos](#modelo-de-datos)
  - [Rutas Relacionadas](#rutas-relacionadas)
  - [Helpers y Utilidades](#helpers-y-utilidades)
- [Sistema de Consentimiento de Cookies](#sistema-de-consentimiento-de-cookies)
  - [Funcionalidad](#funcionalidad)
  - [Tipos de Cookies](#tipos-de-cookies)
  - [Implementación Técnica](#implementación-técnica)
  - [Persistencia](#persistencia)
  - [Integración](#integración)
  - [Cumplimiento y Privacidad](#cumplimiento-y-privacidad)
- [Suscripciones, Pagos y Planes y API Keys](#suscripciones-pagos-y-planes-y-api-keys)
